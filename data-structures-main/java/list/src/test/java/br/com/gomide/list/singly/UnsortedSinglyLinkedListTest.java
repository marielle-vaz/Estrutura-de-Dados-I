...
public class UnsortedSinglyLinkedListTest {
  ...
  class Insertion {
    ...
    public void insertElementsAtInitSuccessfully() {
      ...
      assertEquals("4 -> 8 -> 5 -> 2 -> volta ao inicio", content);
    }
    ...
    public void insertElementsAtEndSuccessfully() {
      ...
      assertEquals("2 -> 5 -> 8 -> 4 -> volta ao inicio", content);
    }
    ...
    public void insertElementsSuccessfuly() {
      ...
      assertEquals("8 -> 5 -> 2 -> 4 -> volta ao inicio", content);
    }
  ...
  class Remove {
    ...
    public void removeAnExistingElement() {
      ...
      assertTrue(removed);
      assertEquals("2 -> 8 -> 4 -> volta ao inicio", content);
    }
    ...
    public void removeTheLastElement() {
      ...
      assertTrue(removed);
      assertEquals("2 -> 5 -> 8 -> volta ao inicio", content);
    }
    ...
    public void removeTheFirstElement() {
      ...
      assertTrue(removed);
      assertEquals("5 -> 8 -> 4 -> volta ao inicio", content);
    }
